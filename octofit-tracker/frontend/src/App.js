        ...
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navbarNav">
            ...
            <span className="navbar-text">
              <a className="btn btn-outline-light btn-sm" href="https://github.com" target="_blank" rel="noopener noreferrer">GitHub</a>
            </span>
          </div>
        </div>
      </nav>
        ...
        <Routes>
          ...
          <Route path="/" element={
            <div className="card p-4 text-center">
              <h2 className="mb-3 text-primary">Welcome to OctoFit Tracker!</h2>
